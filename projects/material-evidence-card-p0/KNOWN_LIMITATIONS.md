...
- Parse and hash checks passed during packaging. The original `v0.0.7-p0` browser observation remains `UNAVAILABLE`; the patched `replay.2` viewer has an external semantic replay `PASS`, without rewriting that historical record.
